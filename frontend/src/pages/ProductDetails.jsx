          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col">
            ...
            <div className="mt-auto flex flex-col sm:flex-row gap-4">
              ...
              <button
                onClick={handleShare}
                disabled={isSharing}
                className="w-full py-4 px-6 rounded-xl border-2 border-secondary text-secondary hover:bg-secondary hover:text-white font-bold text-lg transition-all shadow-md hover:shadow-lg flex justify-center items-center gap-3 disabled:opacity-60 disabled:cursor-not-allowed"
              >
