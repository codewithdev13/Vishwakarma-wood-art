      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col">
            ...
            <div className="mt-auto flex flex-col lg:flex-row gap-4">
              <button
                onClick={handleWhatsApp}
                className="w-full py-4 px-6 rounded-xl bg-primary hover:bg-[#b0912d] text-secondary font-bold text-lg transition-all shadow-lg hover:shadow-xl flex justify-center items-center gap-3 transform hover:-translate-y-1 cursor-pointer"
              >
              ...
              <button
                onClick={handleShare}
                disabled={isSharing}
                className="w-full py-4 px-6 rounded-xl border-2 border-secondary text-secondary hover:bg-secondary hover:text-white font-bold text-lg transition-all shadow-md hover:shadow-lg flex justify-center items-center gap-3 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
              >
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-xl border-2 transition-all shadow-md hover:shadow-lg flex justify-center items-center gap-3 cursor-pointer ${
                  isShortlisted
